...
cdef extern from "enet/enet.h":
    ...
    ctypedef struct ENetHost:
        ...
        enet_uint8 usingNewPacketForServer
...
cdef class Host:
    ...
    cdef enet_uint8 _usingNewPacket
    cdef enet_uint8 _usingNewPacketForServer
    ...
    def __init__ (self, Address address=None, peerCount=0, channelLimit=0,
        ...
        self.dealloc = True
        self._checksum = 0
        self._usingNewPacket = 0
        self._usingNewPacketForServer = 0
    ...
    property usingNewPacket:
        def __get__(self):
            return self._usingNewPacket

        def __set__(self, value):
            self._enet_host.usingNewPacket = value
            self._usingNewPacket = value

    property usingNewPacketForServer:
        def __get__(self):
            return self._usingNewPacketForServer
            
        def __set__(self, value):
            self._enet_host.usingNewPacketForServer = value
            self._usingNewPacketForServer = value
